...
namespace idk
{
    internal class SinhVien
    {
        ...
        public bool AddSV(string masv, string hoten, DateTime ngaysinh, string quequan, string gioitinh, string khoa, string lop, string diachi, string sdt)
        {
        ...
        public bool CapNhat(string masv, string hoten, DateTime ngaysinh, string quequan, string gioitinh, string khoa, string lop, string diachi, string sdt)
        {
